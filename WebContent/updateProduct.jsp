				...
				<div class="row">
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="South_Indian_Food"
								<%="South_Indian_Food".equalsIgnoreCase(ptype) ? "selected" : ""%>>South Indian Food</option>
							<option value="Maharastra's_Food"
								<%="Maharastra's_Food".equalsIgnoreCase(ptype) ? "selected" : ""%>>Maharastra's Food</option>
							<option value="breakfast"
								<%="breakfast".equalsIgnoreCase(ptype) ? "selected" : ""%>>BreakFast</option>
							<option value="Nonveg"
								<%="Nonveg".equalsIgnoreCase(ptype) ? "selected" : ""%>>Non-Veg Food</option>
							<option value="Punjabi"
								<%="Punjabi".equalsIgnoreCase(ptype) ? "selected" : ""%>>Punjabi Food</option>
							<option value="chinese"
								<%="chinese".equalsIgnoreCase(ptype) ? "selected" : ""%>>Chainese Food</option>
							<option value="other"
								<%="other".equalsIgnoreCase(ptype) ? "selected" : ""%>>Some Other Food</option>
						</select>
					</div>
				</div>
				<div class="form-group">
