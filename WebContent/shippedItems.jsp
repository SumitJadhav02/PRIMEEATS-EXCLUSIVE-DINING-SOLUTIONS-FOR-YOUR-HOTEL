...
<body style="background-color: #E6F9E6;">
	...
	<div class="text-center"
		style="color: green; font-size: 24px; font-weight: bold;">Delivered
		Orders</div>
			...
			<table class="table table-hover table-sm">
				...
				<tbody style="background-color: white;">
					...
					<tr>
						...
						<td class="text-success" style="font-weight: bold;">Delivered</td>
					...
					<tr style="background-color: grey; color: white;">
						<td colspan="7" style="text-align: center;">No Item
							Available</td>
